...
export declare class ApiClient {
    ...
    createFile: ({ xFilename, xTags, xAccessPolicies, contentType, contentLength, xBotId, xIntegrationId, xUserId, xUserRole, ...createFileBody }: CreateFileProps) => Promise<import("./api").CreateFileResponse>;
